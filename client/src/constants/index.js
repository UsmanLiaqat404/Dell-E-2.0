export const surpriseMePrompts = [
  ...
  "A cityscape illuminated by bioluminescent plants instead of traditional streetlights.",
  "A futuristic cityscape with flying cars, digital art",
  "A vintage pocket watch that opens to reveal a tiny galaxy spinning within.",
  "A mystical forest where the leaves on the trees are transparent and the tree trunks are iridescent.",
  "A bustling Victorian-era marketplace where the vendors are various kinds of mythical creatures selling enchanted items.",
  "A surreal beach where the sand is like blue sapphires and the ocean waves are a flowing cascade of liquid gold.",
  "A futuristic library where books fly freely and knowledge is downloaded directly into the brain through light beams.",
  "A celestial dragon curled around a floating castle in the midst of a nebula.",
  "An enormous greenhouse that houses every type of plant, flower, and tree, from earth and other imaginative alien worlds, all blooming under a multi-sun sky.",
  "An underground kingdom illuminated by glowing crystals, populated by intelligent mole people.",
  "A lighthouse on the edge of the world, shining a beacon into the vastness of outer space.",
];
